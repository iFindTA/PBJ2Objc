...
J2OBJC_FIELD_SETTER(JavaUtilConcurrentConcurrentHashMap, entrySet_, id<JavaUtilSet>)
J2OBJC_FIELD_SETTER(JavaUtilConcurrentConcurrentHashMap, values_, id<JavaUtilCollection>)
...
@interface JavaUtilConcurrentConcurrentHashMap_HashIterator : NSObject {
 @public
  ...
  JavaUtilConcurrentConcurrentHashMap_HashEntry *nextEntry_;
...
J2OBJC_FIELD_SETTER(JavaUtilConcurrentConcurrentHashMap_HashIterator, nextEntry_, JavaUtilConcurrentConcurrentHashMap_HashEntry *)
